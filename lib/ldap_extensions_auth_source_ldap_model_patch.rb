...
module LdapExtensionsAuthSourceLdapModelPatch
  ...
  module InstanceMethods
    def find_in_directory(q)
      ...
      ldap_con.search( :base => self.base_dn, 
        ...
        userHits << get_user_attributes_from_ldap_entry(entry).merge({:uid => entry.uid})
      end
...
AuthSourceLdap.send(:include, LdapExtensionsAuthSourceLdapModelPatch)
